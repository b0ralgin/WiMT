...
- (void)initObjects {
    ...
    [self addObject:@"WaverDark" WithObjectType:TRAP_OBJECT OnPos:CGPointMake(408, 294) Dynamic:NO];
   ...
   // [self addObject:@"Candy" WithObjectType:CANDY_OBJECT OnPos:CGPointMake(900, 108) Dynamic:NO];
    ...
    [self addObject:@"SpikesLight" WithObjectType:ROOM_OBJECT OnPos:CGPointMake(1900, 100) Dynamic:NO];
    [self addObject:@"BedroomDoorClose" WithObjectType:DOOR_OBJECT OnPos:CGPointMake(2000, 120) Dynamic:NO];
    [self addObject:@"SpeakerDark" WithObjectType:ROOM_OBJECT OnPos:CGPointMake(2200, 120) Dynamic:NO];
